...
class DashboardComposer {
    ...
    public function __construct()
    {
        ...
        $this->metricsCountGroupedByDay = DB::select('SELECT DATE_FORMAT(date,\'%d/%m/%Y\') AS date, COUNT(*) AS total FROM metrics WHERE user_id = :user_id GROUP BY DAY(date) ORDER BY date', ['user_id' => Auth::user()->id]);
